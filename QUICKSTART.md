...
1. Go to your new repository 鈫?**Settings** 鈫?**Actions** 鈫?**General** 鈫?**Workflow permissions**
...
1. Go to your repository 鈫?**Actions** tab
2. Wait for the "Deploy site" workflow to complete (look for a green checkmark, ~4 minutes)
3. Go to **Settings** 鈫?**Pages** 鈫?**Build and deployment**
...
See [CUSTOMIZE.md 搂 GitHub Copilot Customization Agent](CUSTOMIZE.md#github-copilot-customization-agent) for details.
