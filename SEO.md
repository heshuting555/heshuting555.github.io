...
- Visit `https://your-site.com/sitemap.xml` 鈥?Should show an XML list of pages
- Visit `https://your-site.com/robots.txt` 鈥?Should show instructions for search engines
...
3. Verify ownership (choose one method):
   - **HTML file upload** 鈥?Download file, add to repository root
   - **HTML tag** 鈥?Copy meta tag to `_config.yml` 鈫?redeploy
   - **Google Analytics** 鈥?If you already use Google Analytics
   - **DNS record** 鈥?Advanced (if you own the domain)
...
- **Performance** 鈥?Which queries bring traffic, your ranking position
- **Coverage** 鈥?Any indexing errors
- **Enhancements** 鈥?Schema.org validation
- **Sitemaps** 鈥?Your sitemap status
...
4. **Wait 3-6 months** 鈥?Google Scholar takes time to index
...
- **[Google Search Central](https://developers.google.com/search)** 鈥?Official SEO guide
- **[Moz SEO Checklist](https://moz.com/beginners-guide-to-seo)** 鈥?Beginner-friendly guide
- **[Google PageSpeed Insights](https://pagespeed.web.dev/)** 鈥?Performance analysis
- **[Schema.org](https://schema.org/)** 鈥?Structured data reference
- **[WebAIM](https://webaim.org/)** 鈥?Accessibility (helps SEO too)
- **[Lighthouse Audit](https://chrome.google.com/webstore/detail/lighthouse/blipmdconlkpombljlkpstvnztVTNyZe)** 鈥?Browser extension
...
Your research will be more discoverable with these optimizations! 馃攳
